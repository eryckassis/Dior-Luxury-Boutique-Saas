          ...
          <div class="review-modal">
            <div class="review-modal-content">
              ...
              <form class="review-form">
                ...
                <div class="form-group">
                  <label class="form-label" for="review-text-${this.productId}">Sua avaliação do produto *</label>
                  <textarea 
                    id="review-text-${this.productId}" 
                    name="review-text" 
                    class="form-textarea" 
                ...
                <div class="form-group">
                  <label class="form-label" for="reviewer-name-${this.productId}">Entre com seu nome ou apelido *</label>
                  <input 
                    type="text" 
                    id="reviewer-name-${this.productId}" 
                    name="reviewer-name" 
                    class="form-input" 
